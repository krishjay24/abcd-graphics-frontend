        ...
        <div className={styles.letsConnectCol1}>
          <div className='summary-content'>
            ...
            <p>
              ...
              meaningful designs in various form factors that meet the
              objectives of clients.
            </p>
            <p>
              Now that you've reached this section of my website, I think we
              have a strong potential to be great friends, and I always treat my
              friends to something special.
            </p>
            <p>
              Here's a quick sneak peek into some of my creative lines of
              thought that I've executed for various global brands in the past.
            </p>
          </div>
          <div className='summary-content'>
            ...
            <p className={styles.last}>So, Why Me?</p>
          </div>
        </div>
